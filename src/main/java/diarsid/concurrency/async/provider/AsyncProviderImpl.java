...
import static diarsid.concurrency.async.provider.AsyncProvider.asyncProvide;
import static diarsid.concurrency.async.provider.AsyncProviderState.PROVIDING_COMPLETED;
import static diarsid.concurrency.async.provider.AsyncProviderState.PROVIDING_FAILED;
import static diarsid.concurrency.async.provider.AsyncProviderState.PROVIDING_RUNNING;
import static diarsid.concurrency.async.provider.AsyncProviderState.PROVIDING_STOPPED;
